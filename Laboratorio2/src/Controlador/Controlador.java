...
public class Controlador implements ActionListener {
    ...
    Thread sonido = null;
    int contadorPalabraSonido=1;
    int contadorFraseSonido=1;
    int contadorTextoSonido=1;
        ...
        if (e.getSource() instanceof JButton) {
            ...
            if (boton.getText().equals("Siguiente")) {
                if (this.ahorcado.getModoJuego().equals("Palabras")) {
                    sonido = new Thread(new Audio("p"+(contadorPalabraSonido)));
                    contadorPalabraSonido++;
                    if(contadorPalabraSonido==6){contadorPalabraSonido=1;}
                    ...
                    sonido = new Thread(new Audio("f"+contadorFraseSonido));
                    contadorFraseSonido++;
                    if(contadorFraseSonido==5){contadorFraseSonido=1;}
                    ...
                    sonido = new Thread(new Audio("t"+contadorTextoSonido));
                    contadorTextoSonido++;
                    if(contadorTextoSonido==6){contadorTextoSonido=1;}
